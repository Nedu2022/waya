...
export default function LoanCalculator() {
  ...
  const interestRate = 0.04; // 4% monthly interest
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent-purple/[0.03] rounded-full blur-3xl animate-blob" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-primary/[0.03] rounded-full blur-3xl animate-blob-delay-2" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-[clamp(2rem,4.5vw,3rem)] font-extrabold leading-[1.1] tracking-tight text-dark mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-purple to-primary">
                Without the Wait
              </span>
            </h2>
            <p className="text-[1.0625rem] lg:text-[1.125rem] leading-relaxed text-slate-500 mb-10">
            ...
            <ul className="flex flex-col gap-4 mb-10">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center gap-3 text-slate-700 font-medium text-[0.9375rem]"
                >
